...
<div class="row col-lg-12">
    ...
    <div class="card col-lg-6" style="padding: 0px">
        <div class="card-header">
          <i class="fa fa-"></i> Detail Struk Pesanan</div>
        <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
          <div class="row">
             <div class="col-lg-12">
              <div class="table-responsive">
                ...
                <!-- <strong>Total Iteam :</strong>    <?php echo $Total_Item_Overall+1000;?><br>
    ...
    <div class="card col-lg-6" style="padding: 0px;float: right;">
        ...
        <form action="" method="POST" >
          <div class="row">
              ...
              <div class="form-group col-lg-12">
                <textarea class="form-control" name="Address" required="" placeholder="Alamat"><?php echo $info_User_Get->Address;?></textarea>
              </div>            
