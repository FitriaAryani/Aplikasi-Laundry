          ...
          <div class="row">
           ...
           <div class="form-group col-lg-12">   
            <div id="Mor_Eve"></div>
              ...
              <div class="form-group col-lg-12" >
                 <label for="exampleInputEmail1">Jenis Pesanan</label>
              ...
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Harga Reguler (Rp <?php echo $Data->Dry_Price; ?>)</label>
            ...
            <?php if($Data->Laundry_Price>0){?>
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Harga Express (Rp <?php echo $Data->Laundry_Price; ?>)</label>
            ...
            <?php }?>
              ...
              <div class="form-group col-lg-12">
                <input  name="" type="button" onclick="submitPass<?php echo $Order_Id?>()"  class="btn btn-success form-control" value="Tambah ">
              </div>
            </div>  
